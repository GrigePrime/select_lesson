<?php
/* Smarty version 3.1.34-dev-7, created on 2023-11-23 16:12:52
  from 'C:\Users\ASUS\WebstormProjects\select_lesson\templates\search.html' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_655f7a04245954_87939342',
...
function content_655f7a04245954_87939342 (Smarty_Internal_Template $_smarty_tpl) {
?><br>
<form action="Search.php" class="form-inline" method="get" style="padding-left: 70px;">
    ...
    <input class="form-control" id="class_name" name="class_name" placeholder="請輸入課程名稱" style="margin-top: 5px; margin-bottom: 3px;"
           type="text">
    <button id="searchnamebutton" style="width: 30px;height: 30px;" type="submit">
        <img alt="search" src="templates/web_image/search.png" width="20px">
    </button>
    </br>
    <input class="form-control" id="class_teacher" name="class_teacher" placeholder="請輸入課程教授" style="margin-top: 5px; margin-bottom: 3px;"
           type="text">
    <button id="searchteacherbutton" style="width: 30px;height: 30px;" type="submit">
        <img alt="search" src="templates/web_image/search.png" width="20px">
    </button>
